...
<form action="{{ route('faq.store') }}" method="POST" class="max-w-2xl">
    @csrf
    <div class="mb-4">
    ...
    <div class="mb-4">
        ...
        <textarea name="answer" id="answer" rows="5" class="w-full border rounded px-3 py-2" required placeholder="Enter answer">{{ old('answer') }}</textarea>
    </div>

    <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded hover:bg-indigo-700">Create FAQ</button>
</form>
@endsection
